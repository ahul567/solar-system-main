...
import ic_facebook from '../assets/logos_facebook.svg'
import ic_apple from '../assets/devicon_apple.svg'
import ic_google from '../assets/devicon_google.svg'
...
const icons = [ic_facebook, ic_apple, ic_google]
    ...
    <div className='win-box'>
      ...
      <div className="mailbox">
        <div className='sub-box-mail'>
          {database.typebox.map((item, index) => (
            <div type="email"
              key={index}
              className='input-box-mail'
              style={{ display: 'flex', gap: '4.3%', marginTop: '5%', marginLeft: '1.8%' }}
            >
      ...
      <div className="social-icons">
        {icons.map((icon, index) => (
          <div key={index} className="med_icon">
            <img className="img_icon" src={icon} alt="social" />
          </div>
        ))}
      </div>
       <div className="signup-account">
        <p className="exist-acount">Don't have an account?<a href="" className="signup-link">Sign Up</a></p>
       </div>
    </div>
  )
}